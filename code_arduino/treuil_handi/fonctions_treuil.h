...
public:
  ...
  treuil(char button, char moteur, char adr_treuil_max, char adr_treuil_min, char adr_joy_max, char adr_joy_min, char adr_joy_neutre);
...
private:
  char button_pin, moteur_pin, adr_ee_treuil_max, adr_ee_treuil_min, adr_ee_joy_max, adr_ee_joy_min, adr_ee_joy_neutre;
